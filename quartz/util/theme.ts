...
:root {
  ...
  --titleFont: "${getFontSpecificationName(theme.typography.title || theme.typography.header)}";
  --headerFont: "${getFontSpecificationName(theme.typography.header)}";
  --bodyFont: "${getFontSpecificationName(theme.typography.body)}";
